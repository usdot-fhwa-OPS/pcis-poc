...
import { useAnalyticsData } from '../components/analytics/use-analytics-data.tsx';
import { BcoAnalyticsDashboard } from '../components/analytics/bco-analytics-dashboard.tsx';
import { TerminalAnalyticsDashboard } from '../components/analytics/terminal-analytics-dashboard.tsx';
import { TransOpAnalyticsDashboard } from '../components/analytics/transop-analytics-dashboard.tsx';
import type { BCOAnalyticsData, TerminalAnalyticsData, TransOpAnalyticsData } from '../components/analytics/analytics-types.ts';
...
function Index() {
  const { user } = useAuthenticator();
    ...
    const { analyticsData, terminalCapacityRecords, loading: analyticsLoading } = useAnalyticsData(userAttributes.role);
