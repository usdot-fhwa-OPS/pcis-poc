      ...
      <div className="w-full px-6 py-6 md:px-10 md:py-8">
        ...
        <Tabs defaultValue="requested">
          <TabsList className="justify-start gap-x-6 w-full h-auto p-0 mb-4 bg-transparent border-b border-gray-200">
            <TabsTrigger value="requested" className="mb-0 data-[state=active]:-mb-px pt-0 px-0 pb-2 data-[state=active]:bg-transparent border-b-0 data-[state=active]:border-b-2 border-transparent data-[state=active]:border-gray-900 rounded-none text-gray-500 hover:text-gray-700 data-[state=active]:text-gray-900 shadow-none data-[state=active]:shadow-none">Requested</TabsTrigger>
            <TabsTrigger value="modification" className="mb-0 data-[state=active]:-mb-px pt-0 px-0 pb-2 data-[state=active]:bg-transparent border-b-0 data-[state=active]:border-b-2 border-transparent data-[state=active]:border-gray-900 rounded-none text-gray-500 hover:text-gray-700 data-[state=active]:text-gray-900 shadow-none data-[state=active]:shadow-none">Modification Requested</TabsTrigger>
            <TabsTrigger value="ongoing" className="mb-0 data-[state=active]:-mb-px pt-0 px-0 pb-2 data-[state=active]:bg-transparent border-b-0 data-[state=active]:border-b-2 border-transparent data-[state=active]:border-gray-900 rounded-none text-gray-500 hover:text-gray-700 data-[state=active]:text-gray-900 shadow-none data-[state=active]:shadow-none">Ongoing</TabsTrigger>
            <TabsTrigger value="completed" className="mb-0 data-[state=active]:-mb-px pt-0 px-0 pb-2 data-[state=active]:bg-transparent border-b-0 data-[state=active]:border-b-2 border-transparent data-[state=active]:border-gray-900 rounded-none text-gray-500 hover:text-gray-700 data-[state=active]:text-gray-900 shadow-none data-[state=active]:shadow-none">Completed</TabsTrigger>
          </TabsList>
