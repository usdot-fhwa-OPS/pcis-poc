            ...
            <div className="grid grid-cols-3 gap-2 items-center">
                ...
                <div className="col-span-3 mt-8 mb-6">
                    ...
                    <ol className="space-y-4 list-decimal list-inside">
                        <li>Locate your cargo manifest file on your computer. Locate your cargo manifest file on your computer. <span class="text-sm text-muted-foreground">(Supported file formats: .csv, .xls, .txt)</span></li>
